...
public class Windowing2Lexer extends Lexer {
    ...
    public final void mHIVEQUERY() throws RecognitionException {
        try {
            int _type = HIVEQUERY;
            // Windowing2.g:541:11: ( '<' ( HiveQueryEscapeSequence | ~ ( '>' ) )* '>' )
            // Windowing2.g:541:13: '<' ( HiveQueryEscapeSequence | ~ ( '>' ) )* '>'
            {
            match('<'); 
            // Windowing2.g:542:3: ( HiveQueryEscapeSequence | ~ ( '>' ) )*
            loop3:
            do {
                int alt3=3;
                ...
                switch (alt3) {
            	case 1 :
            	    // Windowing2.g:542:4: HiveQueryEscapeSequence
            	    {
